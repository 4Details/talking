...
@Controller
public class MessageController implements TalkingConstant {
    ...
    public String sendLetter(String toName, String content) {
        ...
        if (target == null) {
            return TalkingUtil.getJSONString(1, "目标用户不存在!");
        }
    ...
    public String getNoticeList(Model model) {
        ...
        if (message != null) {
            ...
            String content = HtmlUtils.htmlUnescape(message.getContent()); //去除content中的html转义字符
