...
import com.wx.talking.entity.*;
import com.wx.talking.event.EventProducer;
import com.wx.talking.service.CommentService;
...
public class DiscussPostController implements TalkingConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return TalkingUtil.getJSONString(403, "你还没有登录哦!");
        }
        ...
        // 报错的情况,将来统一处理.
        return TalkingUtil.getJSONString(0, "发布成功!");
    }
