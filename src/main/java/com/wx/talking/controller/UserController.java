...
@Controller
@RequestMapping("/user")
public class UserController implements TalkingConstant {

    private static final Logger logger = LoggerFactory.getLogger(UserController.class);

    @Value("${talking.path.upload}")
    ...
    public String getSettingPage(Model model) {
        ...
        policy.put("returnBody", TalkingUtil.getJSONString(0));
        // 生成上传凭证
    ...
    public String updateHeaderUrl(String fileName) {
        if (StringUtils.isBlank(fileName)) {
            return TalkingUtil.getJSONString(1, "文件名不能为空!");
        }
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        // 生成随机文件名
        fileName = TalkingUtil.generateUUID() + suffix;
        // 确定文件存放的路径
        ...
        // http://localhost:8080/talking/user/header/xxx.png
