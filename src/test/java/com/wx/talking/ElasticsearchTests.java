...
import com.wx.talking.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testInsertList(){
        ...
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(3,0,100,0));
    }

    @Test
    public void testUpdate(){
        DiscussPost discussPost = discussPostMapper.selectDiscussPostById(12);
        discussPost.setContent("dasdjs");
        discussPostRepository.save(discussPost);
    }

    @Test
    public void testDelete(){
//        discussPostRepository.deleteById(1); // 通过id删除
//        discussPostRepository.deleteAll(); //删除所有
    }
